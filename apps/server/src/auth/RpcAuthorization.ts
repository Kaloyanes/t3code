...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.automationsGetSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.automationsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsPause]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsResume]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsRunNow]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsRetryRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.automationsStopRun]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.promptEnhance]: AuthOrchestrationOperateScope,
  [WS_METHODS.promptEnhanceStream]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.issuesCommentCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesCommentUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesCommentDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesReactionUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesClose]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesReopen]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesInvalidate]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesLink]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesWorktreePrepare]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesWorktreeDeletePreflight]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesWorktreeDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesWorktreeReplace]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesAuthStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesAuthStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesAuthCancel]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.worktreeRunStart]: AuthTerminalOperateScope,
  [WS_METHODS.worktreeRunAttach]: AuthTerminalOperateScope,
  [WS_METHODS.worktreeRunWrite]: AuthTerminalOperateScope,
  [WS_METHODS.worktreeRunResize]: AuthTerminalOperateScope,
  [WS_METHODS.worktreeRunClear]: AuthTerminalOperateScope,
  [WS_METHODS.worktreeRunStop]: AuthTerminalOperateScope,
  [WS_METHODS.subscribeWorktreeRuns]: AuthTerminalOperateScope,
