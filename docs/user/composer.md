...
On web and desktop, a queued message is submitted immediately but starts as a
separate turn only after the agent finishes its current turn. Tool-call
boundaries do not release queued messages.
