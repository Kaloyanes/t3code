...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server owns durable scheduled agent automations and their run controls. */
  scheduledAutomations: Schema.optionalKey(Schema.Boolean),
  ...
  /** Server can stream prompt enhancement progress and generated text. */
  promptEnhancementStreaming: Schema.optionalKey(Schema.Boolean),
  ...
  /** Server persists and exposes created pull requests at worktree scope. */
  worktreePullRequests: Schema.optionalKey(Schema.Boolean),
