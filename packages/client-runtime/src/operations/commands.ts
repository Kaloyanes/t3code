...
export type UnlinkWorktreePullRequestInput = CommandInput<"project.worktree-pull-request.unlink">;
...
export const unlinkWorktreePullRequest: (input: UnlinkWorktreePullRequestInput) => CommandEffect =
  Effect.fn("EnvironmentCommands.unlinkWorktreePullRequest")(function* (input) {
    return yield* dispatch({
      ...input,
